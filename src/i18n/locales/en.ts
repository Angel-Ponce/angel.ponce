const en: Record<string, string> = {
	...
	'Una plataforma multi-empresarial que facilita la gestión de recursos humanos en todos los aspectos posibles.':
		'Multi enterprise platform to improve the managment of human resources at all.',
	'Una plataforma útil para gestionar horarios estudiantiles y actividades personales.':
		'Useful platform to manage academic schedules and personal activities.',
	'Sistema de análisis de votación política para medir la cantidad de escaños obtenidos por partido.':
		'Political voting analysis system.',
	'Una librería útil para implementar reacciones con emojis en programas escritos con Svelte.':
		'Useful library to implement emoji reactions with svelte programs.',
	'Sitio web informativo para el laboratorio de investigación ITIC, el sitio es totalmente personalizable y configurable.':
		'Web site for investigation labs (ITIC), absolute customizable and configurable.',
	'Solución integral de gestión inteligente del agua, sistema IoT accesible y confiable para administrar el consumo de agua en los hogares.':
		'Integral solution of smart managment of water, IoT and accesible system to manage the houses water consumption.',
	'Sistema de control de prestamos educativos en Centro Universitario del Norte.':
